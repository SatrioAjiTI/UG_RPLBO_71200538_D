...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71200538 = new User("Satrio Aji Utomo", "satrio.aji@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200538 = new GoPay(U_71200538);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71200538.getUser().getNama()+"] - ");
        E_71200538.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200538.getUser().getNama()+"] - ");
        E_71200538.topup(50000);
        System.out.print("["+E_71200538.getUser().getNama()+"] - ");
        E_71200538.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71200538, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71200538.getUser().getNama()+"] - ");
        E_71200538.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71200538.getUser().getNama()+"] - ");
        E_71200538.withdraw(1100);
